...
/**
 * Számla kiállítási válasz
 */
class IssueInvoiceResponse
{
    /**
     * Sikeres-e a kiállítás
     */
     ...
     * Vevői fiók URL
     */
    private ?string $customerAccountUrl = null;
    ...
    /**
     * IssueInvoiceResponse konstruktor
     * 
     * @param bool $success Sikeres kiállítás
     */
    ...
    public static function fromArray(array $data): self
    {
        ...
        if (isset($data['outstandingAmount'])) {
            $response->setOutstandingAmount($data['outstandingAmount']);
        }
        
        if (isset($data['customerAccountUrl'])) {
            $response->setCustomerAccountUrl($data['customerAccountUrl']);
        }
    ...
    /**
     * Kintlevőség beállítása
     * 
     * @param string|null $outstandingAmount Kintlevőség
     * @return self
     */
    ...
    /**
     * Vevői fiók URL beállítása
     * 
     * @param string|null $customerAccountUrl Vevői fiók URL
     * @return self
     */
    public function setCustomerAccountUrl(?string $customerAccountUrl): self
    {
